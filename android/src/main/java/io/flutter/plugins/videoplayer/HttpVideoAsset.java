...
final class HttpVideoAsset extends VideoAsset {
  ...
  public MediaSource.Factory getMediaSourceFactory(@NonNull Context context) {
    // Use the cached data source factory from VideoCache
    ...
    unstableUpdateDataSourceFactory(httpDataSourceFactory, httpHeaders, userAgent);
    
    // Use our custom CacheDataSource.Factory from VideoCache instead of DefaultDataSource
    DataSource.Factory dataSourceFactory = VideoCache.getDataSourceFactory(context);
  ...
  MediaSource.Factory getMediaSourceFactory(
    ...
    // Use our custom CacheDataSource.Factory instead of DefaultDataSource
    DataSource.Factory dataSourceFactory = VideoCache.getDataSourceFactory(context);
